...
interface MonthlyBudgetCircleProps {
	percentage?: number;
	spent?: number;
	total?: number;
	onPeriodToggle: () => void;
...
const MonthlyBudgetCircle = ({
	percentage = 0,
	spent = 0,
	total = 0,
	onPeriodToggle,
	isActive = true,
}: MonthlyBudgetCircleProps) => {
	const size = 140; // 50 * 2 + 8 (radius * 2 + strokeWidth)
			...
			<View style={styles.circleCard}>
				...
				<RectButton style={styles.periodToggleButton} onPress={onPeriodToggle}>
					<View style={styles.periodToggleContent}>
						<Text style={styles.periodToggleText}>Monthly</Text>
					</View>
				</RectButton>
...
export default MonthlyBudgetCircle;
