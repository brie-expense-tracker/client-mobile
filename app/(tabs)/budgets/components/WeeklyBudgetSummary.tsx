...
interface WeeklyBudgetCircleProps {
	percentage?: number;
	spent?: number;
	total?: number;
	onPeriodToggle: () => void;
...
const WeeklyBudgetCircle = ({
	percentage = 0,
	spent = 0,
	total = 0,
	onPeriodToggle,
	isActive = true,
}: WeeklyBudgetCircleProps) => {
			...
			<View style={styles.circleCard}>
				...
				<RectButton style={styles.periodToggleButton} onPress={onPeriodToggle}>
					<View style={styles.periodToggleContent}>
						<Text style={styles.periodToggleText}>Weekly</Text>
					</View>
				</RectButton>
...
export default WeeklyBudgetCircle;
