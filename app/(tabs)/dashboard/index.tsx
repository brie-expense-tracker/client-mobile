...
import { InsightsSummary, SmartActionsSummary } from '../../../src/components';
 ...
 * -----------------------------------------------------------------------------
 */
const QuickFinancialSummary: React.FC<{ transactions: Transaction[] }> = ({
	transactions,
}) => {
		...
		<View style={styles.aiInsightsContainer}>
			<View style={styles.aiInsightsHeader}>
				...
				<TouchableOpacity onPress={() => router.push('/insights')}>
					<Text style={styles.viewAllInsightsText}>View All</Text>
				</TouchableOpacity>
			</View>
			<InsightsSummary maxInsights={1} compact={true} title="" />
		</View>
	);
};
