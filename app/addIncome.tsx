...
const AddIncomeScreen = () => {
	...
	return (
		...
		>
			{/* Background */}
			<View className="w-[200%] h-[500px] -top-20 absolute bg-green-500 rounded-[50%] overflow-hidden self-center">
				<LinearGradient
					colors={['#41A85F', '#1b8438']}
					start={{ x: 0.1, y: 0 }}
					end={{ x: 0.5, y: 0.5 }}
				>
			...
			<View className="p-6 mt-36">
				<ScrollView>
					<View className="bg-white py-10 px-6 rounded-3xl">
						{/* Income Label */}
						<Text className="text-xl text-gray-600 mb-2">Income</Text>
