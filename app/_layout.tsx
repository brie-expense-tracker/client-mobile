...
const queryClient = new QueryClient({
	defaultOptions: {
		queries: {
			...
			gcTime: 10 * 60 * 1000, // Keep cache 10 minutes (prevents blank states on tab switch)
			refetchOnWindowFocus: false, // Mobile: prevents "jumpy" reloads when switching tabs
